...
const News = () => {
  const newsItems = [
    { id: '1', category: "Tin Tức", title: "Bảng báo giá thi công phần thô tại Đà Nẵng mới nhất 2026", date: "12/07/2026", excerpt: "Cập nhật chi tiết chi phí nhân công và vật tư xây dựng phần thô (cát, đá, xi măng, sắt thép) tại khu vực miền Trung.", img: "https://images.unsplash.com/photo-1513694203232-719a280e022f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
    { id: '2', category: "Kinh Nghiệm", title: "Kinh nghiệm chọn vật liệu xây dựng tiết kiệm chi phí", date: "05/07/2026", excerpt: "Làm thế nào để xây phần thô với ngân sách hợp lý mà vẫn đảm bảo độ vững chắc? Dưới đây là những mẹo hay từ kỹ sư kết cấu của Xây Dựng Nhà Đà Nẵng.", img: "https://images.unsplash.com/photo-1503387762-592deb58ef4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
    { id: '3', category: "Sự Kiện", title: "Lễ cất nóc dự án Biệt Thự Vườn tại Cẩm Lệ", date: "28/06/2026", excerpt: "Một cột mốc quan trọng trong tiến độ dự án, hoàn thành xong toàn bộ phần khung sườn bê tông cốt thép bởi đội ngũ Xây Dựng Nhà Đà Nẵng.", img: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
  ];
      ...
      <div className="container py-16">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '2.5rem', marginTop: '3rem' }}>
          {newsItems.map((item, idx) => (
            <Link to={`/news/${item.id}`} key={idx} className={`news-card animate-slide-up delay-${(idx % 3 + 1) * 100}`}>
